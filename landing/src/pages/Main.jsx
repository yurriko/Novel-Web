                ...
                <div id="news" className="justify-self-start lg:ml-28 ml-0">
                    <div className="flex space-x-6">
                        ...
                        <p className="text-gray-400 pb-5">
                            Мы — команда, стоящая за идеей, которую мы вынашивали, прорабатывали и готовили к реализации с глубоким пониманием и энтузиазмом. К сожалению, с огорчением вынуждены признать, что до полноценного запуска нашего проекта кто-то реализовал похожее решение раньше нас.
                            Это непростой момент. Видеть, как твоя идея — то, во что ты вложил месяцы размышлений, исследований и прототипов — появляется под другим именем, другим лицом и другим логотипом, но с таким знакомым содержанием, вызывает смешанные чувства. С одной стороны, это знак того, что мы двигались в верном направлении. С другой — горько осознавать, что наш потенциал не получил своевременного воплощения.
                            В современном мире технологии и мысли развиваются параллельно, и одинаковые идеи могут прийти к разным людям одновременно. Но мы хотим честно зафиксировать факт: мы действительно работали над этой концепцией раньше, и наша реализация была в процессе.
                            Это не конец. Мы продолжаем двигаться вперед, сохраняя верность собственному пути. У нас есть не только идеи, но и видение того, как сделать их по-настоящему уникальными.
                            Если вы однажды увидите похожий продукт под другим именем — знайте: у каждой истории есть та сторона, о которой не всегда пишут в пресс-релизах.
